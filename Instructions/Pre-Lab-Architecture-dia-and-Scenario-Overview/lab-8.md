...
Now that you know what the lab is going to be all about, you can launch next item **Hands-on Lab** which includes lab environment and lab guide. You can also preview the full lab guide [here](https://experience.cloudlabs.ai/#/labguidepreview/844c9338-e384-4e43-ae46-2ff25fe51faf) if you want to go through detailed guide prior to launching lab environment.