...
Now that you know what the lab is going to be all about, you can launch next item **Hands-on Lab** which includes lab environment and lab guide. You can also preview the full lab guide [here](https://experience.cloudlabs.ai/#/labguidepreview/d919c7be-fc3f-45fc-8b73-09648d1f29e3) if you want to go through detailed guide prior to launching lab environment. 