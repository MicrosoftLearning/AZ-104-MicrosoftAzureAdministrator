...
Now that you know what the lab is going to be all about, you can launch next item **Hands-on Lab** which includes lab environment and lab guide. You can also preview the full lab guide [here](https://experience.cloudlabs.ai/#/labguidepreview/f5def2c2-66e5-4d52-8354-94bfe1fcc590) if you want to go through detailed guide prior to launching lab environment.