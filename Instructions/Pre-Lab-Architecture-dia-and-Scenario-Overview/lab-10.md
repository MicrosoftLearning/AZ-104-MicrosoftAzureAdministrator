...
Now that you know what the lab is going to be all about, you can launch next item **Hands-on Lab** which includes lab environment and lab guide. You can also preview the full lab guide [here](https://experience.cloudlabs.ai/#/labguidepreview/91b023a8-63f5-4301-af98-eaf0e4705c18) if you want to go through detailed guide prior to launching lab environment.