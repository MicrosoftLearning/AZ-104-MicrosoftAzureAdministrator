...
1. To use existing resource group in the same Azure region as the **az104-03c-rg1-[DeploymentID]** resource group you created in the previous lab, from the Bash session within Cloud Shell, run the following:
