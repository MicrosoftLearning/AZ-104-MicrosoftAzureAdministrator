...
1. Search for and select **Delete Virtual Machine (Virtual Machines)** to expand the menu, then select the appropriate option. Select **Apply**. Notice the other built-in signals.
